...
namespace MyTestServices.Interfaces
{
    ...
    public partial interface IHelloWorldService
    {
        ...
        string LoginTimeMethod();
        Task<string> LoginTimeMethodAsync();
...
namespace MyTestServices.ServerServices
{
    ...
    public partial class HelloWorldService : IHelloWorldService
    {
        ...
        public string LoginTimeMethod()
        {
                return  SignalGo.Client.ClientManager.ConnectorExtensions.SendDataSync<string>(CurrentProvider, ServiceName,"LoginTimeMethod", new SignalGo.Shared.Models.ParameterInfo[]
                {
                });
        }
        public Task<string> LoginTimeMethodAsync()
        {
                return SignalGo.Client.ClientManager.ConnectorExtensions.SendDataAsync<string>(CurrentProvider, ServiceName,"LoginTimeMethod", new SignalGo.Shared.Models.ParameterInfo[]
                {
                });
        }
...
namespace MyTestServices.HttpServices
{
    public partial class HelloWorldService : IHelloWorldService
    {
        ...
        public string LoginTimeMethod()
        {
                SignalGo.Client.HttpClientResponse result = _httpClient.Post(_serverUrl + (_serverUrl.EndsWith("/") ? "" : "/") + "helloworld/LoginTimeMethod", new SignalGo.Shared.Models.ParameterInfo[]
                {
                });
                ResponseHeaders = result.ResponseHeaders;
                Status = result.Status;
        ...
        public async Task<string> LoginTimeMethodAsync()
        {
                SignalGo.Client.HttpClientResponse result = await _httpClient.PostAsync(_serverUrl + (_serverUrl.EndsWith("/") ? "" : "/") + "helloworld/LoginTimeMethod", new SignalGo.Shared.Models.ParameterInfo[]
                {
                });
                ResponseHeaders = result.ResponseHeaders;
                Status = result.Status;
...
namespace MyTestServices.ClientServices
{
    ...
    public partial interface IHelloCallbackClientService
    {
        void ReceivedMessage(string name, string family);
        void ReceivedMessageBase(string name, string family);
    }
}
